...
class TestUniqueSelectors(unittest.TestCase):
    ...
    def fill_form(self, link):
        ...
        browser.find_element(By.CSS_SELECTOR, '.first_block .first').send_keys('Misha')
        browser.find_element(By.CSS_SELECTOR, '.first_block .second').send_keys('Snow')
        browser.find_element(By.CSS_SELECTOR, '.third_class .third').send_keys('SUS@AMOGUS')
